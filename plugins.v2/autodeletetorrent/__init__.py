...
class AutoDeleteTorrent(_PluginBase):
    # 插件名称
    plugin_name = "自动删种（自用）"
    # 插件描述
    plugin_desc = "自动删除下载器中的下载任务。(修改辅种不满足删种条件则跳过)"
    # 插件图标
    ...
    # 插件配置项ID前缀
    plugin_config_prefix = "AutoDeleteTorrent_"
    # 加载顺序
    plugin_order = 8
    # 可使用的用户级别
    auth_level = 2
